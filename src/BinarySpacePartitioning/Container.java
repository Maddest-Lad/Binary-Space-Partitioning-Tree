 ...
 * @author Sam Harris
 * @version 1.0
 *     <p>This class represents a grid (or subgrid) containing it's start and endpoints in the x and
 *     z axes.
 */
public class Container {
  ...
  public static void splitContainer(TreeNode<Container> node) {
    ...
    switch (Direction.getRandomDirection()) {
      ...
      case VERTICAL:
        mid = Utils.randomInRange(container.bottom, container.top);
  ...
  public void fillArrayByContainer(String[][] arr) {
